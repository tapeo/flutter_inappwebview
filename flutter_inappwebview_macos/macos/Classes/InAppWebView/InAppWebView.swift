...
public class InAppWebView: WKWebView, WKUIDelegate,
    ...
    lazy var downloadManager: InAppWebViewDownloadManager = InAppWebViewDownloadManager(webView: self)
...
//            }
    ...
    public func getDownloadedFilePath(for originalUrl: String) -> String? {
        return downloadManager.getDownloadedFilePath(for: originalUrl)
    }
